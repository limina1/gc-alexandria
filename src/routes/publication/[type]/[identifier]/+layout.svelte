...
<svelte:head>
  <!-- Basic meta tags -->
  <title>{meta.title || "MedSchlr - Nostr Publications"}</title>
  <meta
    name="description"
    content={meta.summary || "Read and discover long-form content on Nostr"}
  />

  <!-- OpenGraph meta tags -->
  <meta
    property="og:title"
    content={meta.title || "MedSchlr - Nostr Publications"}
  />
  <meta
